...
<ul>
<li><div style="height:15em;width:100%;background:red;">11</div></li>//根据大家对文章的点赞数目降序排列，列出一天之内头3名文章
<li><div style="height:15em;width:100%;background:gold;">22</div></li>
<li><div style="height:8em;width:100%;background:purple;">33</div></li>
</ul>
</div>
